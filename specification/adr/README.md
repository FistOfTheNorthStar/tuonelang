...
dogfooding exercise — see [`DOGFOODING.md`](../../DOGFOODING.md). ADR-0004 has
since been accepted and landed; 0006/0007/0008 remain `proposed` pending their
normative spec, fixtures, and performance-lab entries.)
