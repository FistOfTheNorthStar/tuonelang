...
//! Cranelift backend — instruction for instruction. It lowers the same **scalar,
//! control-flow core**:
//!
//! - integer, boolean, and `Char` values (scalars in virtual registers);
...
//! fall back to the interpreter (the reference).
//!
//! # Optimization
//!
